...
#'
#' @param month is an integer for the month number (1 to 12)
#' @param jday is the number of the day in the month
#' @param tu is the time in decimal in UTC
#' @param xlon is the longitude in decimal degree
#' @param xlat is the latitude in decimal degree
#'
#' @return It returns a vector of two numeric for the sun zenith angle and the azimuthal angle of the sun.
#'
#' @author Bernard Gentilly, LOV
