...
Ce document présente les principales fonctionalités du package ASD. Cette librairie a été développée pour calculer les réflectances des surfaces terrestres où des surfaces aquatiques. 
...
* **Rhow_Method** est la méthode de correction de la réflexion spéculaire qui sera retenue **à la fin du traitement** des données. Cette information sera utilisée pour générer la base de données validées. Sept options sont possibles: 
